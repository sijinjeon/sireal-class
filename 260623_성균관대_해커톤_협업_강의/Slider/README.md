...
└── Slider/
    ├── slides/           # 섹션별 소스 (구현 순서)
    ├── theme/lecture.css # Linear DESIGN.md 기반 테마
...
[awesome-design-md](https://github.com/VoltAgent/awesome-design-md)의 **Linear** 토큰을 기반으로 Marp 테마를 구성했습니다.

- **Primary:** Linear lavender `#5e6ad2` · canvas `#010102`
- **Accent:** Cursor orange `#f54e00` (표지 eyebrow)
